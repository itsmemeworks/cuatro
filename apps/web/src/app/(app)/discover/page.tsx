...
export default async function DiscoverPage() {
  ...
  if (!view.hasPatch) {
    return (
      <main className="c4-wide px-5 pt-2 pb-8 min-[900px]:px-8 w-full max-w-[1000px] mx-auto">
        <h1 className="text-[29px] font-extrabold tracking-tight text-ink">Discover</h1>
        <Card className="mt-14 mx-auto max-w-[520px] flex flex-col items-center text-center gap-3 py-7">
          <span
            aria-hidden
  ...
  return (
    <main className="c4-wide px-5 pt-2 pb-8 min-[900px]:px-8 w-full max-w-[1000px] mx-auto flex flex-col gap-6">
      {/* Header */}
      ...
      <section className="flex flex-col gap-3">
        ...
        {view.games.length === 0 ? (
          ...
          <div className="grid grid-cols-1 min-[900px]:grid-cols-2 gap-3.5">
            {view.games.map((g) => (
      ...
      <section className="flex flex-col gap-3">
        ...
        <div className="grid grid-cols-1 min-[680px]:grid-cols-2 min-[1200px]:grid-cols-3 gap-3.5">
