...
/**
 * 404. Wrapped in PhoneFrame so it keeps the centred 448 phone column at every
 * width — the root layout no longer applies a global clamp (that moved into
 * the responsive shell / PhoneFrame for the web waves). One coral action (back
 * to Home), same recipe as the empty-state cards.
 */
